...
namespace AcmeCorp.Migrations
{
    ...
    [Migration("20220320050939_IntroduceHealthCarePatient")]
    partial class IntroduceHealthCarePatient
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AcmeCorp.HealthCare.Patient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("AcmeCorp.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("AcmeCorp.Authorization.Users.User", null)
                        .WithMany("Claims")
