...
{
    public abstract class AcmeCorpWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AcmeCorpWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AcmeCorpWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AcmeCorpDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AcmeCorpDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AcmeCorpDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AcmeCorpDbContext, Task<T>> func)
        {
            T result;
